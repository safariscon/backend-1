...
const mapPhotonFeature = (feature = {}) => {
  ...
  return {
    ...
    latitudeRaw: latitude != null ? String(latitude) : "",
    longitudeRaw: longitude != null ? String(longitude) : "",
    placeId: osmId ? `osm:${osmType}:${osmId}` : "",
    country: properties.country || "Rwanda",
    countryCode: String(properties.countrycode || "rw").toUpperCase(),
    ...
    city: properties.city || properties.county || properties.district || "",
    sector: properties.locality || properties.city || properties.district || "",
    area: properties.locality || properties.suburb || properties.district || "",
...
const mapGooglePlace = (place = {}) => {
  ...
  return {
    ...
    latitudeRaw: location.lat != null ? String(location.lat) : "",
    longitudeRaw: location.lng != null ? String(location.lng) : "",
    placeId: String(place.place_id || "").trim(),
    country: component("country") || "Rwanda",
    countryCode: (
      components.find((entry) => Array.isArray(entry.types) && entry.types.includes("country"))?.short_name || "RW"
    ).toUpperCase(),
    ...
    area: component("sublocality") || component("neighborhood") || component("administrative_area_level_3"),
